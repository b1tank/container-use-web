...
import type {
    ...
    EnvironmentsGetEnvironmentDiffData,
    EnvironmentsGetEnvironmentDiffResponse,
    EnvironmentsExecuteActionData,
    EnvironmentsExecuteActionResponse,
} from "./types.gen"
...
export class EnvironmentsService {
     ...
     * @throws ApiError
     */
    public static getEnvironmentLogs(
        data: EnvironmentsGetEnvironmentLogsData,
    ): CancelablePromise<EnvironmentsGetEnvironmentLogsResponse> {
        return __request(OpenAPI, {
            method: "GET",
     ...
     * @throws ApiError
     */
    public static getEnvironmentDiff(
        data: EnvironmentsGetEnvironmentDiffData,
    ): CancelablePromise<EnvironmentsGetEnvironmentDiffResponse> {
        return __request(OpenAPI, {
            method: "GET",
    ...
    public static executeAction(
        data: EnvironmentsExecuteActionData,
    ): CancelablePromise<EnvironmentsExecuteActionResponse> {
        return __request(OpenAPI, {
            method: "POST",
